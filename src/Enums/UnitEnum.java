...
public enum UnitEnum {
    ...
    public int getStructuralIntegrity(Battle_Technologies tech) {
        return Structural_Integrity + ((Structural_Integrity * tech.getArmour_Technology()) / 10);
    }

    public float getHullPlating(Battle_Technologies tech) {
    ...
    public float getShieldStrength(Battle_Technologies tech) {
    ...
    public float getAttackStrength(Battle_Technologies tech) {
    ...
    public int getFuelUsage(Battle_Technologies technologies) {
        switch (this) {
            case SmallCargo: {
