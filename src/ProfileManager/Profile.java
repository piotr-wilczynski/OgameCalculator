...
public class Profile implements Serializable{
    ...
    public Profile() {
        ...
        localization = OgameApi.OgameApi.getInstance().getLocalization(profiles[0].getLanguage().getServerCountryCode());
    }    
    ...
    public Profile(Locale lang, PlayerProfile[] profiles, int mainProfile) {
        ...
        if(profiles != null && profiles.length>0)
            localization = OgameApi.OgameApi.getInstance().getLocalization(profiles[0].getLanguage().getServerCountryCode(),profiles[0].getServer_ID(),false);
    }    
