...
public enum Unit_Enum{
    ...
    public int getStructural_Integrity(Technologies tech) {
        return Structural_Integrity+((Structural_Integrity*tech.getArmour_Technology())/10);
    }  
    
    public float getHull_Plating(Technologies tech){
    ...
    public float getShield_Strength(Technologies tech) {
    ...
    public float getAttack_Strength(Technologies tech) {
    ...
    public float getSpeed(Technologies tech){
        switch(this){
            case Light_Fighter:
            case Large_Cargo:
            case Recycler:
    ...
    public String toString(Technologies tech) {
        String rapids = "";
