...
public class Battle_Technologies {
    ...
    public Battle_Technologies(int Weapons_Technology, int Shielding_Technology, int Armour_Technology, int Combustion_Drive, int Impulse_Drive, int Hyperspace_Drive) {
    ...
    public Battle_Technologies(int Weapons_Technology, int Shielding_Technology, int Armour_Technology) {
        this.Weapons_Technology = Weapons_Technology;
        this.Shielding_Technology = Shielding_Technology;
        this.Armour_Technology = Armour_Technology;
